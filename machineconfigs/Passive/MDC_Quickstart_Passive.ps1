configuration MDC_Quickstart_Passive
{
    ...
    $ASRACTIONS = @("AuditMode","AuditMode", "AuditMode", "AuditMode", "AuditMode", "AuditMode", "AuditMode", "AuditMode", "AuditMode", "AuditMode", "AuditMode", "AuditMode", "AuditMode", "AuditMode", "AuditMode", "AuditMode")
    Install-Module -Name WindowsDefender
    Import-Module -Name WindowsDefender
    Import-DscResource -ModuleName 'WindowsDefender'
    node localhost
    {
        WindowsDefender Passive
        {
...
MDC_Quickstart_Passive -OutputPath '.\'
